...
--
-- Host: localhost:3306
-- Generation Time: Sep 18, 2018 at 11:06 PM
...
ALTER TABLE `abastecimento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_abastecimento_competencia1_idx` (`evento_id`);
...
ALTER TABLE `aquisicao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_aquisicao_conserto1_idx` (`evento_id`),
  ADD KEY `conserto_id` (`evento_id`);
...
ALTER TABLE `conserto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_conserto_competencia1_idx` (`evento_id`);
...
--
ALTER TABLE `abastecimento`
  ADD CONSTRAINT `fk_abastecimento_evento` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `aquisicao`
--
ALTER TABLE `aquisicao`
  ADD CONSTRAINT `aquisicao_ibfk_1` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `conserto`
--
ALTER TABLE `conserto`
  ADD CONSTRAINT `conserto_ibfk_1` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
